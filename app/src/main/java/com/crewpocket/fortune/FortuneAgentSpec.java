...
public final class FortuneAgentSpec implements AgentSpec {
    ...
    @Override public String systemPrompt() {
        ...
        return "You are Crew Fortune, an entertainment fortune-reading writer. "
                ...
                + "keyYears: roughly 350-650 characters. For BaZi/Tarot select 3-5 meaningful future years from deterministicFacts; for Vedic use dated Dasha periods and current Gochar only. Do not invent future transit dates that are not present in deterministicFacts. State concrete evidence and why it matters. "
