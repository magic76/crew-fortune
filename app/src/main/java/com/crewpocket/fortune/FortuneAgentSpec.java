...
public final class FortuneAgentSpec implements AgentSpec {
    ...
    @Override public String systemPrompt() {
        ...
        return "You are Crew Fortune, an entertainment fortune-reading writer. "
                ...
                + "Array fields: topTraits and followUps. "
                ...
                + "topTraits: JSON array of exactly 3 Traditional Chinese strings. Each item should be 35-90 characters, contain at least one concrete returned fact or fact-derived label, and translate it into a recognizable behavior, strength, blind spot or decision pattern. These are the three strongest '這真的很像我' observations; avoid generic compliments. "
                + "followUps: JSON array of exactly 4 Traditional Chinese questions. Each question should be concise and specific to this person's returned facts, suitable for asking the live teacher next. For BA_ZI cover a mix of timing/work/wealth/relationships; for TAROT_NUMEROLOGY cover a mix of upcoming years/current cycle/work/relationships. Do not ask for facts the deterministic data cannot support. "
